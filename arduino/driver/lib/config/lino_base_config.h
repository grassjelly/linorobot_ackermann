...
#define REAR_LEFT_ENCODER_A 10
#define REAR_LEFT_ENCODER_B 9
// Right side encoders pins
#define REAR_RIGHT_ENCODER_A 11
#define REAR_RIGHT_ENCODER_B 12
...
#define rear_right_motor_pwm 23
#define rear_right_motor_in_1 17
#define rear_right_motor_in_2 16
